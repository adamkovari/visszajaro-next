        ...
        <div className='z-[3] flex flex-col gap-x-5 items-center w-11/12 relative md:flex-row'>
          ...
          <div className='hidden md:flex md:basis-1/2 justify-center md:justify-end'>
            <div className='md:w-10/12 flex items-center relative'>
              <Image className='hidden mx-auto h-full w-full xl:w-5/6 rounded-lg' src="/assets/vendeglatas.webp" width={2000}
      ...
      <div className='relative bg-white-bg'>
        <div className='relative py-32 w-11/12 mx-auto text-center'>
          ...
          <div className='w-5/6 flex pt-12 flex-row flex-wrap justify-center overflow-hidden gap-16 mx-auto'>
              <WorkflowCard className={classNames(scrollPosition > 1900 ? 'translate-x-0 opacity-100' : 'translate-x-[-20rem] opacity-0', 'basis-full sm:basis-1/5 duration-[1000ms]',)} dir={false} head={'QR kód beolvasása'} text={'Érkezéskor a vendég beszkenneli az asztalánál található QR kódot, így látja az appban az asztalát, menüt, stb. A vendég megjelenik a vendéglátós szoftverben az asztalánál.'} icon={'/assets/workflow/qr-kod-beolvasas.webp'} idx={1} alt={'Asztalra kihelyezett QR kód beolvasása'} />
              ...
              <WorkflowCard className={classNames(scrollPosition > 2300 ? 'translate-x-0 opacity-100' : 'translate-x-[-20rem] opacity-0', 'basis-full sm:basis-1/5 duration-[1000ms]',)} dir={true} head={'Saját tételek kiválasztása'} text={'A vendég kiválaszthatja az asztalról a saját rendeléseit az appban. A vendéglátós szoftverben megjelennek a kiválasztott tételek az adott székhez rendelve.'} icon={'/assets/workflow/sajat-tetelek-kivalasztasa.webp'} idx={3} alt={'Saját tételek kivaálsztása a Visszajáróban'} />

              <WorkflowCard className={classNames(scrollPosition > 2450 ? 'translate-x-0 opacity-100' : 'translate-x-[20rem] opacity-0', 'basis-full sm:basis-1/5 duration-[1000ms]',)} dir={true} head={'Fizetés'} text={'A vendég fizet az appban, vagy a pincérnél. Fizetheti a teljes asztalt, vagy csak a saját tételeit. A vendéglátós szoftver jelzi, ha az egész asztalt kifizették.'} icon={'/assets/workflow/fizetes.webp'} idx={4} alt={'Fizetés a Visszajáróval'} />
          </div>
        </div>
      </div>
